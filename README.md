...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`716`,`None`,`Personal public GitHub repository listing`
...
* [`dictionary-web-app`](https://github.com/lloydlobo/dictionary-web-app),`TypeScript`,`2962`,`None`,`Integrate the Dictionary API to create a real-world dictionary web app.`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`47153`,`None`,`Lloyd Lobo's GitHub profile.`
