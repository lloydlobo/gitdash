...
* [`headcount`](https://github.com/lloydlobo/headcount),`Python`,`763`,`None`,`A HTMX + Python Flask demo for live attendance management`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`108`,`None`,`Personal public GitHub repository listing`
...
* [`privateer`](https://github.com/lloydlobo/privateer),`Rust`,`88`,`None`,`Toggle multiple git repository's visibility interactively from your terminal`
