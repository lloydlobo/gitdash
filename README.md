...
* [`BFInterpreter`](https://github.com/lloydlobo/BFInterpreter),`F#`,`280`,`None`,`A simple BF interpreter in F#`
...
* [`dev`](https://github.com/lloydlobo/dev),`Shell`,`120`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`543`,`None`,`Personal public GitHub repository listing`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`46914`,`None`,`Lloyd Lobo's GitHub profile.`
