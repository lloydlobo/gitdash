...
* [`go-headcount`](https://github.com/lloydlobo/go-headcount),`Go`,`17747`,`None`,`A HTMX + Go demo for live attendance management`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`217`,`None`,`Personal public GitHub repository listing`
...
* [`privateer`](https://github.com/lloydlobo/privateer),`Rust`,`89`,`None`,`Toggle multiple git repository's visibility interactively from your terminal`
...
* [`homely-recipes`](https://github.com/lloydlobo/homely-recipes),`HTML`,`17604`,`MIT`,`The site that recommends hand-picked home-made recipes prepared with love and ca...`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`46313`,`None`,`Lloyd Lobo's GitHub profile.`
