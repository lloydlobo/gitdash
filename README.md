...
* [`dev`](https://github.com/lloydlobo/dev),`Lua`,`1153`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`753`,`None`,`Personal public GitHub repository listing`
