...
* [`dotfile-nvim`](https://github.com/lloydlobo/dotfile-nvim),`Lua`,`541`,`None`,`basic nvim config`
...
* [`dev`](https://github.com/lloydlobo/dev),`Shell`,`181`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`46924`,`None`,`Lloyd Lobo's GitHub profile.`
