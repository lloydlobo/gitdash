...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`590`,`None`,`Personal public GitHub repository listing`
...
* [`dictionary-web-app`](https://github.com/lloydlobo/dictionary-web-app),`TypeScript`,`2906`,`None`,`Integrate the Dictionary API to create a real-world dictionary web app.`
