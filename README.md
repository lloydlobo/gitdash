...
* [`dev`](https://github.com/lloydlobo/dev),`Shell`,`123`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`46933`,`None`,`Lloyd Lobo's GitHub profile.`
