...
* [`dev`](https://github.com/lloydlobo/dev),`Shell`,`201`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`504`,`None`,`Personal public GitHub repository listing`
