...
* [`dictionary-web-app`](https://github.com/lloydlobo/dictionary-web-app),`TypeScript`,`2951`,`None`,`Integrate the Dictionary API to create a real-world dictionary web app.`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`47130`,`None`,`Lloyd Lobo's GitHub profile.`
