...
* [`codecrafters-claude-code-typescript`](https://github.com/lloydlobo/codecrafters-claude-code-typescript),`TypeScript`,`12`,`None`,`Learn about LLM APIs, tool calling, agent loops and more`
* [`mixedsignals`](https://github.com/lloydlobo/mixedsignals),`JavaScript`,`30986`,`None`,`Game submission for ludum dare ldjam 59 signal theme. (original 3 day jam: https...`
...
* [`r3f-tshirt-configurator`](https://github.com/lloydlobo/r3f-tshirt-configurator),`TypeScript`,`1066`,`None`,`Clone of react-three-fiber demo`
...
* [`memegen`](https://github.com/lloydlobo/memegen),`TypeScript`,`1875`,`None`,`A quick meme generator `
...
* [`dev`](https://github.com/lloydlobo/dev),`Shell`,`173`,`None`,`Build system for starting up my OS (adapted from @ThePrimeagen)`
...
* [`tiptoe`](https://github.com/lloydlobo/tiptoe),`Python`,`253192`,`None`,`Sneakily collect sleepy guardians in this 2D-platformer game.`
...
* [`gitdash`](https://github.com/lloydlobo/gitdash),`Python`,`636`,`None`,`Personal public GitHub repository listing`
...
* [`dictionary-web-app`](https://github.com/lloydlobo/dictionary-web-app),`TypeScript`,`3271`,`None`,`Integrate the Dictionary API to create a real-world dictionary web app.`
...
* [`lloydlobo`](https://github.com/lloydlobo/lloydlobo),`None`,`47037`,`None`,`Lloyd Lobo's GitHub profile.`
